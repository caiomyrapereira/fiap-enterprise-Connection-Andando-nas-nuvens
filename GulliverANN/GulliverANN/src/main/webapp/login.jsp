    ...
    <main id="app" class="container-fluid m-0 g-0">
      ...
      <div class="login_box mt-5">
        <div class="row align-items-center">
          <div class="my-4">
            <h1 class="text-center mb-3 dyn-font">ACESSE A SUA CONTA</h1>
            <h2 class="text-center dyn-font">Já tem uma conta?</h2>
          </div>
          ...
          <section class="login m-auto px-4">
            <form action="logar" method="get">
              ...
              <div class="mb-3">
                <input type="password" name="txtSenha" class="form-control w-100 rounded" id="exampleInputPassword1"
            ...
            <p class="text-center mb-5">Ainda não tem uma conta? <a href="cadastro.jsp">Cadastre-se.</a> </p>
